...
ALTER TABLE "calendar_slots" ADD CONSTRAINT "calendar_slots_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
